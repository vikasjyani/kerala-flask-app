...
REPORT_I18N = {
    ...
    'ml': {
        ...
        'cost_comparison_heading': 'പ്രതിമാസ ചെലവിന്റെ താരതമ്യം',
        'emissions_comparison_heading': 'വാർഷിക കാർബൺ പുറന്തള്ളലിന്റെ താരതമ്യം',
        ...
        'comparison_monthly_cost': 'പ്രതിമാസ ചെലവ്',
        ...
        'strategic_recommendations': 'പ്രധാന നിർദ്ദേശങ്ങൾ',
        ...
        'chart_monthly_cost_axis': 'പ്രതിമാസ ചെലവ് (Rs)',
        'chart_monthly_cost_title': 'പ്രതിമാസ ചെലവിന്റെ താരതമ്യം',
